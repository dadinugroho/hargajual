...
<div class="d-flex align-items-center mb-4 gap-3">
    <a href="{{ route('item_prices.show', $itemPrice) }}" class="btn btn-sm btn-outline-secondary">&larr; Back</a>
    <h3 class="mb-0">Edit Item Price</h3>
</div>

<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('item_prices.update', $itemPrice) }}">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select id="org_id" name="org_id" class="form-select @error('org_id') is-invalid @enderror" required>
                        ...
                        @foreach($organizations as $org)
                            <option value="{{ $org->id }}" {{ old('org_id', $itemPrice->org_id) == $org->id ? 'selected' : '' }}>
                                {{ $org->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror"
                           value="{{ old('name', $itemPrice->name) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="qty_per_box" name="qty_per_box" step="0.0001" min="0"
                           ...
                           value="{{ old('qty_per_box', $itemPrice->qty_per_box) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="purchase_price" name="purchase_price" step="0.0001" min="0"
                           ...
                           value="{{ old('purchase_price', $itemPrice->purchase_price) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="disc1" name="disc1" step="0.001" min="0" max="1"
                           ...
                           value="{{ old('disc1', $itemPrice->disc1) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="disc2" name="disc2" step="0.001" min="0" max="1"
                           ...
                           value="{{ old('disc2', $itemPrice->disc2) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="disc3" name="disc3" step="0.001" min="0" max="1"
                           ...
                           value="{{ old('disc3', $itemPrice->disc3) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="handling_cost" name="handling_cost" step="0.0001" min="0"
                           ...
                           value="{{ old('handling_cost', $itemPrice->handling_cost) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="additional_cost_base_unit" name="additional_cost_base_unit" step="0.0001" min="0"
                           ...
                           value="{{ old('additional_cost_base_unit', $itemPrice->additional_cost_base_unit) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="additional_cost_box" name="additional_cost_box" step="0.0001" min="0"
                           ...
                           value="{{ old('additional_cost_box', $itemPrice->additional_cost_box) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="cost_price_base_unit" name="cost_price_base_unit" step="0.0001" min="0"
                           ...
                           value="{{ old('cost_price_base_unit', $itemPrice->cost_price_base_unit) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="cost_price_box" name="cost_price_box" step="0.0001" min="0"
                           ...
                           value="{{ old('cost_price_box', $itemPrice->cost_price_box) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="rounding_base_unit" name="rounding_base_unit" step="0.0001" min="0"
                           ...
                           value="{{ old('rounding_base_unit', $itemPrice->rounding_base_unit) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="rounding_box" name="rounding_box" step="0.0001" min="0"
                           ...
                           value="{{ old('rounding_box', $itemPrice->rounding_box) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="profit_base_unit" name="profit_base_unit" step="0.001" min="0" max="1"
                           ...
                           value="{{ old('profit_base_unit', $itemPrice->profit_base_unit) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="profit_box" name="profit_box" step="0.001" min="0" max="1"
                           ...
                           value="{{ old('profit_box', $itemPrice->profit_box) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="selling_price_base_unit" name="selling_price_base_unit" step="0.0001" min="0"
                           ...
                           value="{{ old('selling_price_base_unit', $itemPrice->selling_price_base_unit) }}">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" id="selling_price_box" name="selling_price_box" step="0.0001" min="0"
                           ...
                           value="{{ old('selling_price_box', $itemPrice->selling_price_box) }}">
                    @error('selling_price_box')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="col-12 mt-2">
                    <button type="submit" class="btn btn-primar w-100">Update Item Price</button>
                </div>
            </div>
        </form>
    </div>
