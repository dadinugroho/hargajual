...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('producers.create') }}" class="btn btn-primary">+ {{ __('dashboard.add_producer') }}</a>
</div>
    ...
    <div class="table-responsive" style="overflow: visible">
        <table class="table table-hover mb-0">
            ...
            <tbody>
                        ...
                        <td class="text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="{{ route('producers.show', $producer) }}">{{ __('dashboard.view_item_prices') }}</a></li>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center text-muted py-4">{{ __('dashboard.no_found') }}</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
