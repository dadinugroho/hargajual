...
<div class="card border-0 shadow-sm" style="max-width:480px">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('producers.store') }}">
            ...
            <button type="submit" class="btn btn-primary">{{ __('producers.add_producer') }}</button>
        </form>
    </div>
</div>
@endsection
